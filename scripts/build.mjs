...
export async function build({ root = project, output = path.join(root, 'dist') } = {}) {
  ...
  requireText(site.googleSiteVerification, 'site.googleSiteVerification');
...
<html lang="en"><head><meta charset="utf-8">${favicon(base)}<meta name="viewport" content="width=device-width, initial-scale=1"><title>${escape(pageSeo.title)}</title><meta name="description" content="${escape(pageSeo.description)}"><meta name="robots" content="index, follow"><meta name="google-site-verification" content="${escape(site.googleSiteVerification)}"><link rel="canonical" href="${escape(canonicalUrl)}"><meta property="og:type" content="website"><meta property="og:site_name" content="${escape(site.name)}"><meta property="og:title" content="${escape(pageSeo.title)}"><meta property="og:description" content="${escape(pageSeo.description)}"><meta property="og:url" content="${escape(canonicalUrl)}"><meta name="twitter:card" content="summary"><meta name="twitter:title" content="${escape(pageSeo.title)}"><meta name="twitter:description" content="${escape(pageSeo.description)}"><script type="application/ld+json">${structuredData}</script><link rel="stylesheet" href="${base}style.css?v=${cssVersion}"><script src="${base}site.js?v=${jsVersion}" defer></script></head><body class="page-${escape(route.replaceAll('/','') || 'home')}">
